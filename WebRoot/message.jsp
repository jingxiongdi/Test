...
<body>
	...
	<div class="content">
		...
		<div class="message-cen">
			<button type="submit" onclick="location='userinfo.jsp'"
				class="btn btn-default register_btn" id="mes-uinfo">个人信息</button>
			<br>
			<button type="submit" onclick="location='BeginExam'"
				class="btn btn-default register_btn" id="mes-exam">开始考试</button>
		</div>
		<%								
							}else{
