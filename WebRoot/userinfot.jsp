...
<div class="head">
	...
	<div class="userinfo-div">
			...
			<ul>
				...
				<li><h4 class="user-li-span">职别:</h4><h4>老师</h4></li>
				<li><h4 class="user-li-span">工号:</h4><h4><%=user.getId()%></h4></li>

			</ul>
			
		</div>
		<div class="user-right">
		<button type="button" onclick="location='seditusert.jsp'" class="btn btn-default user_btn uin-uinfo" >修改个人信息</button><br>
		<button type="button" onclick="location='userconft.jsp'" class="btn btn-default user_btn uin-uinfo" >查看学生信息</button><br>
		<button type="button" onclick="location='teacher.jsp'" class="btn btn-default user_btn uin-uinfo">返回</button>
