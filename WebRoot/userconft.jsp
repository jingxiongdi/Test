...
<body>
	...
	<div class="content">
		<div class="reg-form-div">
			...
			<form class="form-horizontal" role="form" action="deleteAusert"
				...
				<div class="user-confin-div">
					...
					<%
						Connection conn = ConnectionManager.getConnection();
							String sql = "select * from userinfo where role in ('s')";
							...
							while (rs.next()) {
								out.println("<ul>" + "<li>"
										+ "<input type='checkbox' name='checkbox' class='checkboxd' value='"
				...
				<div class="form-group ">
					<div class="uconfbtn">
						...
						<button type="button" onclick="location='userinfot.jsp'"
