...
%>
  ...
  <body>
     <form name="form6" method="post" action="deletepaper">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width='80%'>
						<form name="form10" method="post" action="servlet/deletepaper">
      ...
      <tr bgcolor="#FFFFFF"> 
        <td colspan="2" align="center"><h3>删除试题</h3></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td align="right">待删试题序号：</td>
        <td><input name="deleteid" type="text" id="deleteid" style="width:200px"></td>
        </tr>
